  ...
  const services = [
    {
      ...
      features: ["ประเมินราคาฟรี", "โปรโมทออนไลน์", "นัดหมายลูกค้า", "ประสานงานปิดดีล"],
    ...
    },
    {
      ...
      description: "ให้ข้อมูลเชิงลึกในการลงทุน วิเคราะห์ศักยภาพตลาด คำนวณผลตอบแทน ประเมินความเสี่ยง พร้อมคำแนะนำเรื่องแผนการเงิน การจัดโครงสร้างการลงทุน และกลยุทธ์ซื้อ–ขาย–ถือครองอย่างยั่งยืน",
      features: ["วิเคราะห์ ROI", "ประเมินความเสี่ยง", "แผนการเงิน", "กลยุทธ์ลงทุน"],
    ...
    },
    {
      ...
      features: ["เฟอร์นิเจอร์คุณภาพ", "ของตกแต่งพรีเมี่ยม", "บริการจัดวาง", "ครบจบในที่เดียว"],
    ...
    },
    {
      ...
      description: "บริการออกแบบครบวงจร ตั้งแต่แนวคิด การจัดผังพื้นที่ การเลือกวัสดุและโทนสี การทำรูปแบบ 2D/3D รวมถึงควบคุมงานติดตั้งจริง จัดการโครงการจนเสร็จสมบูรณ์ตามแนวทางของลูกค้าอย่างกลมกลืนและใช้งานได้จริง",
      features: ["ออกแบบ 2D/3D", "เลือกวัสดุและสี", "ควบคุมงานติดตั้ง", "จัดการโครงการ"],
    ...
    },
    {
      ...
      features: ["ทีมวิศวกร", "ช่างเฉพาะทาง", "ควบคุมงบประมาณ", "คุณภาพสูงสุด"],
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <CardContent className="space-y-4">
                ...
                <Button 
                  variant="outline" 
                  className="w-full group-hover:bg-gold-600 group-hover:text-white group-hover:border-gold-600 transition-all duration-300"
                >
                  เรียนรู้เพิ่มเติม
